...
== X3VSAG25 @4
END 
++ @5 DO ~IncrementGlobal("X3VieApp","GLOBAL",2)DisplayStringNoNameDlg(Player1,@513)~  + torment 
++ @6 + consequences 
+~ReputationGT(Player1,12)~+ @7 DO ~IncrementGlobal("X3VieApp","GLOBAL",3)DisplayStringNoNameDlg(Player1,@513)~ + message
...
+~!Race(Player1,ELF)Global("X3VieRomanceActive","GLOBAL",2)~+ @31 DO ~IncrementGlobal("X3VieApp","GLOBAL",6)DisplayStringNoNameDlg(Player1,@516)~ EXTERN X3Vie25J not_elf_romance
+~Race(Player1,ELF)Global("X3VieRomanceActive","GLOBAL",2)~+ @31 DO ~IncrementGlobal("X3VieApp","GLOBAL",6)DisplayStringNoNameDlg(Player1,@516)~ EXTERN X3Vie25J elf_romance  
+~!Global("X3VieRomanceActive","GLOBAL",2)OR(2)Race(Player1,ELF)GlobalGT("X3VieApp","GLOBAL",49)~+ @31 DO ~IncrementGlobal("X3VieApp","GLOBAL",6)DisplayStringNoNameDlg(Player1,@516)~ EXTERN X3Vie25J friend 
